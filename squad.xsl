...
<xsl:template match="/">
	...
	Created by LightEightSix, 09.Jan13
        Reviewed by TomNedry, 09.Jul13
	Lisence: Creative Common (http://creativecommons.org/licenses/by-nc-sa/2.5/deed.de)
	To have a squad logo in the HTML output, just put a "sqd_banner.png" in the same folder...
	-->
	<BODY>
	<!--Main TABLE -->                                                                             
	<TABLE class="main">
		...
		<TABLE class="sqd_info">
			...
			<TR height="100%">
				<TD width="100%" height="100%" valign="top">
					<DIV class="sqd_logo">
					<img src="http://www.danslaby.net/arma_squadxml/images/sqd_banner.png" alt="Picture: Squad Logo"/>
					</DIV>
				</TD>
			</TR>
			<TR height="10">
	...
	"squad.xsl" by <a href="http://gsngaming.com/user/210-lighteightsix/">LightEightSix</a>, last change: 10.Jan13
	</p>
	</BODY>
	</HTML>
</xsl:template>
